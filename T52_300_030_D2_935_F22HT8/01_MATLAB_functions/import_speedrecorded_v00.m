function speedrecorded = import_speedrecorded_v00(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   SPEEDRECORDED = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   SPEEDRECORDED = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   speedrecorded = importfile('speed_recorded.txt', 1, 4001);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2023/04/03 10:52:37
...
speedrecorded = [dataArray{1:end-1}];
