...
ROTOR_NAME='NEOM_BCL1009';

ref_critical_phi=517;
ref_critical_imp_name=strcat('T52_',num2str(ref_critical_phi),'_030_D2_1230_F22HT8');

ref_folder1='\T52_444_030_D2_1230_F22HT8\';
ref_folder2='\T52_653_030_D2_1230_F22HT8\';

input_file_speedname_ref='speed_recorded_const_1009_days_speed.txt';
speed_file_loc=pwd;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Do you have a new rotor?
new_rotor='Yes'; % Answers: 'Yes' 'No'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if ROTOR_STATUS(1,1)==1 % Can we switch on the rotor?
    ...
    NC_FCGR_launcher_T52_444_v03

    cd(strcat(speed_file_loc,ref_folder2));
    NC_FCGR_launcher_T52_653_v03
    ...
    for i=1:n_comp
        ...
        filename=strcat('res_min_LIFE_T52_444_030_1230_',component_names{1,i},'.txt');
    ...
    for i=1:n_comp
        ...
        filename=strcat('res_min_LIFE_T52_653_030_1230_',component_names{1,i},'.txt');
    ...
    LIFE_ROTOR=interp1([444 653],[minlife_imp1 minlife_imp2],ref_critical_phi);
